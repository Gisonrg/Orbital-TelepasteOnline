...
(function($){
    ...
    $.WebcamQRCode.defaultOptions = {
    	messageNoFlash:		"Sorry, your devide doesn't support flash.",
        onQRCodeDecode: 	function( p_data ){ console.log( "onQRCodeDecode data: " + p_data ); },
    ...
    $.WebcamQRCode.start = function( $this ){
        ...
        _flash.append('<param name="scale" value="ExactFit"/>');
